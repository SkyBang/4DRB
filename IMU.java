...
@TeleOp(name = "IMU123", group = "Sensor") // Comment this out to add to the opmode list
...
{   DcMotor MotorDF = null;
    ...
    @Override public void runOpMode() {
        ...
        while (opModeIsActive()) {
            ...
            //zAccumulated=angles.thirdAngle;
            //zAccumulated=angles.secondAngle;
            telemetry.addData(" zacc:", zAccumulated);
            telemetry.addData(" target", target);
            telemetry.update();
            while((target-angles.firstAngle)>13.75 && ok==0)
            {
